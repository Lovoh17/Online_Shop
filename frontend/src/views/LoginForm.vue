    ...
    <header class="bg-white sticky top-0 z-50 shadow-sm">
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center h-14">
          <router-link to="/" class="text-2xl font-black text-gray-900 tracking-tight">CAMILLE</router-link>
          <nav class="flex items-center">
            <router-link 
              to="/register" 
              class="text-sm font-semibold text-gray-900 hover:text-gray-700 transition-colors"
            >
              Crear cuenta
            </router-link>
          </nav>
      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg overflow-hidden border border-gray-200">
          ...
          <div class="p-6">
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <!-- Mensaje de error -->
              <div v-if="errorMessage" class="text-red-600 text-sm text-center py-2 px-3 bg-red-50 rounded-md border border-red-200">
                {{ errorMessage }}
              </div>
        ...
        <div class="mt-6 grid grid-cols-2 gap-4 text-center">
          <div class="bg-white p-4 rounded-lg border border-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
