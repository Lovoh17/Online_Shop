<template>
  <div class="min-h-screen bg-gray-50 overflow-hidden">
    ...
    <main class="flex items-center justify-center py-6 px-4 max-h-screen overflow-y-auto scrollbar-hide">
      <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              <div>
                ...
                <input id="name" v-model="form.name" type="text" required
                  ...
                  :class="{ 'border-red-500': errors.name }" placeholder="Ingresa tu nombre completo">
              ...
              <div>
                ...
                <input id="email" v-model="form.email" type="email" required
                  class="w-full px-4 py-3 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-pink-500 focus:border-pink-500 transition"
                  :class="{ 'border-red-500': errors.email }" placeholder="tucorreo@ejemplo.com">
              ...
              <div>
                ...
                <div class="relative">
                  <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required
                    minlength="8"
                    class="w-full px-4 py-3 text-sm border border-gray-300 rounded-md focus:ring-1 focus:ring-pink-500 focus:border-pink-500 transition"
                    :class="{ 'border-red-500': errors.password }" placeholder="Mínimo 8 caracteres">
              ...
              <div>
                <label for="passwordConfirmation" class="block text-sm font-medium text-gray-700 mb-1">Confirmar
                  contraseña</label>
                <div class="relative">
          ...
          <div class="bg-gray-50 px-6 py-4 text-center border-t border-gray-200">
            <p class="text-sm text-gray-600">
              ...
              <router-link to="/login" class="font-medium text-pink-500 hover:text-pink-600">
                Inicia sesión
              </router-link>
            </p>
          </div>
        ...
        <div class="mt-6 grid grid-cols-2 gap-4 text-center">
          <div class="bg-white p-3 rounded-lg border border-gray-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto text-pink-500" fill="none"
              viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
/* Ocultar scrollbar global también */
html, body {
  overflow-x: hidden;
}
