  ...
  <footer class="bg-gray-100 text-gray-700 pt-12 pb-6 border-t border-gray-200">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="text-gray-500 hover:text-pink-500" aria-label="Facebook">
            ...
            <a href="#" class="text-gray-500 hover:text-pink-500" aria-label="Instagram">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path fill-rule="evenodd"
      ...
      <div class="border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-x-4">
          <img src="https://th.bing.com/th/id/R.c7b8552689fc9bf2cf541d80c817d8c2?rik=6%2fQpNehhAsOOZg&pid=ImgRaw&r=0"
            alt="Visa" class="h-6">
          <img src="https://th.bing.com/th/id/OIP.2GBsE98iH4hZsEB-8DZqNQHaHa?r=0&rs=1&pid=ImgDetMain" alt="Mastercard"
            class="h-6">
          <img src="https://th.bing.com/th/id/R.bd1419f2f730ef7ba64126743e0e391e?rik=9ZRBG8q8wWAKmA&pid=ImgRaw&r=0"
...
<script setup>
// No necesita lógica adicional por el momento
</script>
